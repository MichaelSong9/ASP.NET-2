    ...
    <div>
        <div style="text-align: center; ">
                        ...
                        <table border="0" cellpadding="1" cellspacing="0" style="border-collapse: collapse">
                            <tr>
                                <td style="width: 348px; height: 130px; text-align: center">
                                        ...
                                        <tr>
                                            <td align="right" style="width: 145px; height: 24px; text-align: right">
                                                <asp:Label ID="UserNameLabel" runat="server" AssociatedControlID="UserName" Font-Bold="True"
                                                    Font-Names="Verdana" Font-Size="Small" ForeColor="#333399" style="text-align: right">Usuário:</asp:Label></td>
                                            <td style="height: 24px; text-align: left; width: 177px;">
                                                &nbsp;<asp:TextBox ID="UserName" runat="server" TabIndex="1" Width="145px"></asp:TextBox>
                                                <asp:RequiredFieldValidator ID="UserNameRequired" runat="server" ControlToValidate="UserName" Style="text-align: right" ToolTip="Digite o usuário"
                                    ...
                                    &nbsp; &nbsp; &nbsp;
                                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                                    &nbsp; &nbsp;<asp:Button ID="btnAcessar" runat="server" BackColor="White" BorderColor="#507CD1" BorderStyle="Solid"
                                        BorderWidth="1px" CommandName="Login" Font-Names="Verdana" Font-Size="0.8em"
                                        ForeColor="#284E98" TabIndex="5" Text="Acessar" ValidationGroup="cLogin" OnClick="Page_Load"/></td>
                            </tr>
                            <tr>
            ...
            <asp:Panel ID="Panel1" runat="server"
                Height="362px" Width="725px">
                <br />
                &nbsp;<br />
                <br />
                <div style="z-index: 104; left: 331px; width: 169px; position: absolute; top: 48px;
                    height: 100px">
                    <input id="txtResolucao" type="text" runat="server" visible="true" style="width: 1px; background-color: transparent; visibility: hidden;"/>
                </div>
                <br />
                <br />
                &nbsp;<br />
                ...
                &nbsp;
                    <div style="z-index: 101; left: 120px; width: 543px; position: absolute; top: 178px;
                        height: 181px; background-color: #f2f7fe; border-top-style: solid; border-top-color: #333399; border-bottom: thin double; border-right-style: double; border-left-style: double;">
                        <br />
                        <div style="z-index: 103; left: 2px; width: 169px; position: absolute; top: 4px;
                            height: 53px">
                            <asp:Image ID="Image1" runat="server" ImageUrl="~/App_Themes/CCL/Imagens/logo_CCL800x600.gif" /></div>
                        <br />
