<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Altera_Senha.aspx.vb" Inherits="usuario_Altera_Senha" title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="DIV_PAGES" style="text-align: center">
        ...
        &nbsp;<asp:Panel ID="Panel1" runat="server"  CssClass="DIV_ALTSENHA">
            <asp:ChangePassword ID="cMudarSenha" runat="server" BackColor="#EFF3FB" BorderColor="#B5C7DE" BorderPadding="4" BorderStyle="Solid" BorderWidth="1px" CancelDestinationPageUrl="~/Pagina_Principal.aspx" ContinueDestinationPageUrl="~/Pagina_Principal.aspx" Font-Names="Verdana" Font-Size="0.8em" Height="114px" Width="327px">
                                ...
                                <table border="0" cellpadding="0" style="width: 309px; height: 161px">
                                    ...
                                    <tr>
                                        <td align="right" style="width: 179px">
                                            <asp:Label ID="CurrentPasswordLabel" runat="server" AssociatedControlID="CurrentPassword">Senha atual:</asp:Label></td>
                                    ...
                                    <tr>
                                        <td align="right" style="width: 179px; height: 29px;">
                                            <asp:Label ID="ConfirmNewPasswordLabel" runat="server" AssociatedControlID="ConfirmNewPassword">Confirme a Nova Senha:</asp:Label></td>
                                        <td style="width: 125px; height: 29px;">
                                            <asp:TextBox ID="ConfirmNewPassword" runat="server" Font-Size="0.8em" TextMode="Password" ToolTip="Confirme a nova senha"></asp:TextBox>&nbsp;
                                            </td>
                                    </tr>
                                    <tr>
                                        <td align="right" style="height: 35px; width: 179px;">
                                            <asp:Button ID="ChangePasswordPushButton" runat="server" BackColor="White" BorderColor="#507CD1"
                                                ...
                                                Font-Size="0.8em" ForeColor="#284E98" OnClick="ChangePasswordPushButton_Click"
                                                Text="Mudar a Senha" ValidationGroup="ChangePassword1" />
                                        </td>
