...
Public Class clRecTipoRemetente
    ...
    Public Function Imprimir(ByVal Conn As String) As DataTable
        Dim Fields() As String = {"P_CODLOC", "P_TIPREM", "P_CODREM", "P_TIPDOC01", "P_TIPDOC02", "P_TIPDOC03", "P_TIPDOC04", "P_TIPDOC05", "P_TIPDOC06", "P_TIPDOC07", "P_TIPDOC08", "P_TIPDOC09", "P_TIPDOC10", "P_DATRECI", "P_DATRECF"}
        Dim Param() As String = {CODLOC.ToString(), TIPREM.ToString(), CODREM.ToString(), TIPDOC1.ToString(), TIPDOC2.ToString(), TIPDOC3.ToString(), TIPDOC4.ToString(), TIPDOC5.ToString(), TIPDOC6.ToString(), TIPDOC7.ToString(), TIPDOC8.ToString(), TIPDOC9.ToString(), TIPDOC10.ToString(), DATRECI.ToString(), DATRECF.ToString()}
