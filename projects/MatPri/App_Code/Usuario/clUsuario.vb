...
Public Class clUsuario
    ...
    Public Function Validar(ByVal Conn As String) As OracleDataReader
        ...
        Dim Param As String() = {ID_LOGIN_USUARIO.ToString(), "3", CD_SENHA.ToString(), OPER.ToString()}
    ...
    Public Function Alterar(ByVal Conn As String) As OracleDataReader
        ...
        Dim OConexao As New clsOracleServer20
        Return OConexao.ExecutarOperacao(Conn, "PR_ADI_UPD_SEN_TB_SG_USUARIO", Fields, Param)
    End Function
End Class