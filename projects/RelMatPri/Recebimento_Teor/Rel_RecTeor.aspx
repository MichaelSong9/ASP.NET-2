                    ...
                    <tr>
                        ...
                        <td align="left" style="width: 132px; height: 29px">
                            <asp:DropDownList ID="ddl_TipoDocumento" runat="server" CssClass="DROPDOWN_PAGES"
                                ...
                                <asp:ListItem Value="3">GRANELIZADO</asp:ListItem>
                                <asp:ListItem Value="4">EMPRESTIMO</asp:ListItem>
                            </asp:DropDownList></td>
                    </tr>
                    <tr>
                        <td align="right" style="height: 29px">
                        ...
                        <td align="left" style="width: 132px; height: 29px">
                            <asp:DropDownList ID="ddl_Destinacao" runat="server" CssClass="DROPDOWN_PAGES"
                                TabIndex="5" Width="247px" DataSourceID="DesclassificacaoSqlDataSource" DataTextField="TIPDES" DataValueField="TIPDES">
                                <asp:ListItem Value="0">TODOS</asp:ListItem>
                    ...
                    <tr>
                        ...
                        <td align="left" style="width: 132px; height: 28px">
                            ...
                            <asp:ImageButton ID="imbCalendarDe" runat="server" ImageUrl="~/imagens/Calendar_scheduleHS.png"
                                Style="z-index: 1; left: 314px; position: absolute; top: 215px" />
                            <cc1:MaskedEditValidator ID="MaskedEditValidator1" runat="server" ControlExtender="MaskedEditExtender1"
                                ...
                                Style="left: 339px; position: absolute; top: 217px" Width="11px"></cc1:MaskedEditValidator>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td align="left" style="width: 132px; height: 38px">
                            ...
                            <asp:ImageButton ID="imbCalendarAte" runat="server" ImageUrl="~/imagens/Calendar_scheduleHS.png"
                                Style="z-index: 3; left: 314px; position: absolute; top: 255px" />
                            <cc1:MaskedEditValidator ID="MaskedEditValidator2" runat="server" ControlExtender="MaskedEditExtender2"
                                ...
                                InvalidValueMessage="Data Inválida" IsValidEmpty="False" SetFocusOnError="True"
                                Style="left: 341px; position: absolute; top: 255px" Width="11px"></cc1:MaskedEditValidator>
                        </td>
                    </tr>
                </tbody>
            </table>
