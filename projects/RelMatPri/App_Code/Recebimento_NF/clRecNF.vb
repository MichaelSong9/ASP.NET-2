...
Public Class clRecNF
    ...
    Public Function Imprimir(ByVal CONN As String) As DataTable
        Dim Fields() As String = {"P_CODLOC", "P_TIPREM", "P_CODREM", "P_TIPDOC", "P_NUMNFR", "P_NUMDOCI", "P_NUMDOCF", "P_CODPOS", "P_DATRECI", "P_DATRECF"}
        Dim Param() As String = {CODLOC.ToString(), TIPREM.ToString(), CODREM.ToString(), TIPDOC.ToString(), NUMNFR.ToString(), NUMDOCI.ToString(), NUMDOCF.ToString(), CODPOS.ToString(), DATRECI.ToString(), DATRECF.ToString()}
