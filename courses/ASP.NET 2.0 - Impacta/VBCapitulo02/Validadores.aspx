<%@ Page  Trace="true" Language="VB" AutoEventWireup="false" CodeFile="Validadores.aspx.vb" Inherits="Validadores" %>
...
<body>
    ...
    <div><div>
        ...
        <p>
            ...
            <asp:CustomValidator ID="CustomValidator1" runat="server" ControlToValidate="nomeTextBox"
                ErrorMessage="Esse  nome já existe" OnServerValidate="CustomValidator1_ServerValidate"></asp:CustomValidator><br />
            <br />
        ...
        <p>
            &nbsp;</p>
        <p>
            <asp:Button ID="confirmarButton" runat="server" Text="Confirmar" />&nbsp;<asp:Label
